...
if [ "{period}" == "A" ]; then
    mkdir -p /tmp/hgao/{sample_name}/crab_{sample_name}_p0_Dilepton-{sample_name}/
    cp /eos/user/h/hgao/ZZTo2L2Nu/HZZsample/{sample_name}/crab_{sample_name}_p0_Dilepton-{sample_name}/*_$(expr $1 + 1).root /tmp/hgao/{sample_name}/crab_{sample_name}_p0_Dilepton-{sample_name}/
elif [ "{period}" == "B" ]; then
    mkdir -p /tmp/hgao/{sample_name}/crab_{sample_name}_p1_Dilepton-{sample_name}/
    cp /eos/user/h/hgao/ZZTo2L2Nu/HZZsample/{sample_name}/crab_{sample_name}_p1_Dilepton-{sample_name}/*_$(expr $1 + 1).root /tmp/hgao/{sample_name}/crab_{sample_name}_p1_Dilepton-{sample_name}/
elif [ "{period}" == "C" ]; then
    mkdir -p /tmp/hgao/{sample_name}/crab_{sample_name}_p2_Dilepton-{sample_name}/
    cp /eos/user/h/hgao/ZZTo2L2Nu/HZZsample/{sample_name}/crab_{sample_name}_p2_Dilepton-{sample_name}/*_$(expr $1 + 1).root /tmp/hgao/{sample_name}/crab_{sample_name}_p2_Dilepton-{sample_name}/
else 
    mkdir -p /tmp/hgao/{sample_name}/crab_{sample_name}_p3_Dilepton-{sample_name}/
    cp /eos/user/h/hgao/ZZTo2L2Nu/HZZsample/{sample_name}/crab_{sample_name}_p3_Dilepton-{sample_name}/*_$(expr $1 + 1).root /tmp/hgao/{sample_name}/crab_{sample_name}_p3_Dilepton-{sample_name}/
fi
voms-proxy-info -all
