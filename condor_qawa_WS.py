...
#        options.dataset = options.dataset.split('/store')[1].split("/") #for group eos
        options.dataset = options.dataset.split("/")
#        condtag_ = options.dataset[6] #for group eos
#        options.dataset = options.dataset[6] #for group eos
        condtag_ = options.dataset[7]
        options.dataset = options.dataset[7]
