...
$INSTALL_LOC_EXTERNAL/.env/bin/python3 brewer-remote-Fxsec.py --jobNum=$1 --isMC={ismc} --era={era} --infile=$2 --executor={executor} --copyInput
...
def main():
    ...
    brewer_loc_external = os.path.join(os.environ['INSTALL_LOC_EXTERNAL'], "SMQawa", "brewer-remote-Fxsec.py")
