...
echo "+ PWD         = $PWD"
python3 condor_qawa_WS.py --jobNum=$1 --isMC={ismc} --era={era} --infile=$2
...
#    eosbase = "/eos/user/y/yixiao/ntuple/{tag}/{sample}/"
...
#            print (sample)
            ...
            my_eos_space="/eos/user/y/yixiao/histogram/{tag}/VBS/{sample}/"
