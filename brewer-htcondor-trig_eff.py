...
$INSTALL_LOC_EXTERNAL/.env/bin/python3 brewer_remote_trig.py --jobNum=$1 --isMC={ismc} --era={era} --infile=$2 --executor={executor} --copyInput

echo "----- directory after running :"
ls -lthr
if [ ! -f "histogram_$1.pkl" ]; then
...
# transfer_output_files = histogram_$(ProcId).pkl
...
def main():
    ...
    brewer_loc_external = os.path.join(os.environ['INSTALL_LOC_EXTERNAL'], "SMQawa", "brewer_remote_trig.py")
