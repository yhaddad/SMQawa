...
class zzinc_processor(processor.ProcessorABC):
    ...
    def __init__(self, era: str ='2018', dump_gnn_array=False, ewk_process_name=None, run_period: str = ''): 
        ...
        if len(run_period)==0:
            ...
            if self._era == '2016':
                if self._isAPV:
                    if run_period == 'Run2016B' or run_period == 'Run2016C' or run_period == 'Run2016D':
                        jec_tag = f'Summer19UL16APV_RunBCD_V7_DATA'
                    else:
                        jec_tag = f'Summer19UL16APV_RunEF_V7_DATA'
                else:
                    jec_tag = f'Summer19UL16_RunFGH_V7_DATA'
            elif self._era == '2017':
