...
class tauIDScaleFactors:
	def __init__(self, era:str='2022', vsjet_wp:str='VTight', vse_wp:str='VVLoose', vsmu_wp:str='VLoose', isAPV=False):
		self._era = era
		...
		# Load CorrectionSet
		fname = f"{_data_path}/tau_ID_SF/{era+'_EE' if isEE else era}/tau.json.gz"
		...
		self.corr_vsjet = cset["DeepTau2018v2p5VSjet"]
		self.corr_vse = cset["DeepTau2018v2p5VSe"]
		self.corr_vsmu = cset["DeepTau2018v2p5VSmu"]
