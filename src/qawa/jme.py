...
class JMEUncertainty:
    def __init__(
        ...
        # Jet Energy Correction
            f'* * {_data_path}/UL{era}/{jec_tag}_L1FastJet_AK4PFchs.jec.txt',
            f'* * {_data_path}/UL{era}/{jec_tag}_L2L3Residual_AK4PFchs.jec.txt',
            f'* * {_data_path}/UL{era}/{jec_tag}_L2Relative_AK4PFchs.jec.txt',
            f'* * {_data_path}/UL{era}/{jec_tag}_L3Absolute_AK4PFchs.jec.txt',
        ]
        if is_mc:
            correction_list += [    
            # Jet Energy Resolution
                f'* * {_data_path}/UL{era}/RegroupedV2_{jec_tag}_UncertaintySources_AK4PFchs.junc.txt',
                f'* * {_data_path}/UL{era}/{jer_tag}_PtResolution_AK4PFchs.jersf.txt',
                f'* * {_data_path}/UL{era}/{jer_tag}_SF_AK4PFchs.jersf.txt',
            ]
