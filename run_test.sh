...
python brewer-htcondor-2018-MC.py -i data/UL2018_hzzSamples_MC.txt -t vbs --isMC=1 --era=2018
python brewer-htcondor-2018-data.py -i data/UL2018_hzzSamples_Data.txt -t vbs --isMC=0 --era=2018
